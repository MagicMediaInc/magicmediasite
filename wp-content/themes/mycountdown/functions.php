					...
					<div class="span12">
						<div id="myTabContent" class="tab-content">
							...
							<div class="tab-pane fade active in" id="header">
								...
								<div class="row">
									<div class="span2">
										<b><?php _e( 'Twitter ID', 'mycountdown' ); ?></b>
									</div>
									<div class="span5">
										<input id="theme_options[twitterid]" type="text" name="theme_options[twitterid]" value="<?php if ( ! empty( $options[ 'twitterid' ] ) ) printf( esc_attr( '%s', 'mycountdown' ), $options[ 'twitterid' ] ); ?>" />
								...
								<div class="row">
									...
									<div class="span10">
										<input id="theme_options[flickr_url]" type="text" name="theme_options[flickr_url]" value="<?php if ( ! empty( $options[ 'flickr_url' ] ) ) printf( esc_attr( '%s', 'mycountdown' ), $options[ 'flickr_url' ] ); ?>" />
